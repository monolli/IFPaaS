...
single_parser.add_argument("sepal_l", type=float, help="Specify the sepal lenght.", location="query")
single_parser.add_argument("sepal_w", type=float, help="Specify the sepal width.", location="query")
single_parser.add_argument("petal_l", type=float, help="Specify the petal lenght.", location="query")
single_parser.add_argument("petal_w", type=float, help="Specify the sepal width.", location="query")
...
@api.route("/classify_iris/multiple", methods=["GET", "POST"])
